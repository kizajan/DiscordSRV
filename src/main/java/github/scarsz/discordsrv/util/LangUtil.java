 ...
 * <p>TraditionalChinese translations by kizajan</p>
 */
        ...
        ASM_WARNING(new HashMap<Language, String>() {{
           ...
           put(Language.KO,
            ...
            put(Language.ZH,
                    "\n" +
                    "\n" +
                    "您嘗試在ASM 4上使用DiscordSRV。 DiscordSRV 需要 ASM 5 才能作用。\n" +
                    "DiscordSRV 無法在缺少ASM 5的情況下運行。 請向您的伺服器開發人員反應舊版的函式庫。\n" +
                    "\n" +
                    "ASM 5 更新指南:\n" +
                    "1. 開啟伺服器上的 {specialsourcefolder} 資料夾。\n" +
                    "2. 刪除jar檔 SpecialSource-1.7-SNAPSHOT.jar。\n" +
                    "3. 下載 SpecialSource v1.7.4 。網址： http://central.maven.org/maven2/net/md-5/SpecialSource/1.7.4/SpecialSource-1.7.4.jar\n" +
                    "4. 將下載的jar檔放入先前開啟的 {specialsourcefolder} 資料夾。\n" +
                    "5. 並將複製好的檔案重新命名為SpecialSource-1.7-SNAPSHOT.jar。\n" +
                    "6. 重啟伺服器。\n" +
                    "\n" +
                    "\n");
            ...
            put(Language.ET, "=======================================================================================\n" +
                             ...
                             "=======================================================================================");
            put(Language.ZH, "===============================================================================\n" +
                             "               還在找伺服器站台嗎？ 試試PebbleHost! 最低方案只要 $1/GB!\n" +
                             "                 使用優惠碼 \"DISCORDSRV\" 立刻享有前三次帳單-15%折扣\n" +
                             "===============================================================================");
            ...
            put(Language.ZH, "無效的控制台頻道ID, 停止轉送控制台訊息。");
            ...
            put(Language.ZH, "無法自動啟動TownyChat頻道的hook鉤取功能");
            ...
            put(Language.ZH, "已自動啟動Townychat頻道 {amountofchannels} 的hook鉤取功能");
            ...
            put(Language.ZH, "沒有任何TownyChat頻道被自動hook鉤取， 這可能會導致問題...");
            ...
            put(Language.ZH, "啟用 {plugin} 的hook鉤取");
            ...
            put(Language.ZH, "沒有聊天插件Hook鉤取被啟用");
            ...
            put(Language.ZH, "DiscordSRV 連接至 Discord 失敗。 原因");
            ...
            put(Language.ZH, "此BOT並非為Discord所屬。 請參閱安裝指南。");
            ...
            put(Language.ZH, "未連接到頻道及控制台。 請確認是否正確參照安裝指南？");
            ...
            put(Language.ZH, "這個控制台頻道ID已指派至聊天用頻道。 請確認複製至設定檔的ID是否正確");
            ...
            put(Language.ZH, "未安裝Vault。  這需要用來和zPermissions群組同步。 如果你想使用這個功能，請安裝Vault。");
            ...
            put(Language.ZH, "玩家 {player} 以無聲登入權限進入了伺服器，並未發送登入訊息。");
            ...
            put(Language.ZH, "玩家 {player} 以無聲登出權限離開了伺服器，並未發送登出訊息。");
            ...
            put(Language.ZH, "沒有已連結至Discord的帳號，跳過保存。");
            ...
            put(Language.ZH, "已保存已連結帳號，耗時{ms}ms＂）;
            ...
            put(Language.ZH, "因為沒有Metrics指標，跳過儲存。");
            ...
            put(Language.ZH, "Metrics指標已儲存，耗時{ms}ms。");
            ...
            put(Language.ZH, "未找到用來群組同步的身分組 {rolename}。 請確認bot是否在Discord伺服器中。");
            ...
            put(Language.ZH, "我不知道這是什麼番號，回去再試試吧！");
            ...
            put(Language.ZH, "請確認驗證碼是否正確，驗證碼為四位數字。");
            ...
            put(Language.ZH, "因為內部錯誤，現在無法進行帳號連接。 請聯繫您的伺服器管理員。");
            ...
            put(Language.ZH, "很抱歉您沒有操作此指令的權限");
            ...
            put(Language.ZH, "DiscordSRV的設定和詞條已更新");
            ...
            put(Language.ZH, "您的Minecraft帳號已不再連結至 {name}.");
            ...
            put(Language.ZH, "您的Minecraft帳號已連結至 {name}。");
            ...
            put(Language.ZH, "未查找到匹配\"{target}\"的 Discord ID/Discord 名稱/Minecraft 名稱/Minecraft UUID ");
            ...
            put(Language.ZH, "您嘗試發送下列訊息至遊戲中，但此伺服器要求您必須將Minecraft帳號連結至Discord。 在遊戲中輸入 `/discord link`以連結Discord帳號。 \n```{message}```");
            ...
            put(Language.ZH, "你的Minecraft帳號已連結至Discord帳號。 如果您有足夠的權限，可以使用 /discord unlink 來取消連結");    
        }});
